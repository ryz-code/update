...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/ryz-code/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/ryz-code/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/ryz-code/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
wget -qc -O /usr/bin/bbr "https://raw.githubusercontent.com/ryz-code/v4/main/ssh/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /usr/bin/auto-set "https://raw.githubusercontent.com/ryz-code/v4/main/xray/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -qc -O /usr/bin/crtxray "https://raw.githubusercontent.com/ryz-code/v4/main/xray/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
...
mv /home/domain /etc/xray/ 
if [ -f /home/scdomain ];then
rm /home/scdomain > /dev/null 2>&1
fi
clear
rm -f ins-xray.sh  
