...
echo -e "[${COLOR1}02${NC}] • MENU VMESS   [${COLOR1}09${NC}] • MENU SETTINGS"  
echo -e "[${COLOR1}03${NC}] • MENU VLESS   [${COLOR1}10${NC}] • MENU REG IP"  
echo -e "[${COLOR1}04${NC}] • MENU TROJAN  [${COLOR1}11${NC}] • MENU SET BOT"  
echo -e "[${COLOR1}05${NC}] • MENU SS WS   [${COLOR1}12${NC}] • ADD HOST/DOMAIN"
echo -e "[${COLOR1}06${NC}] • MENU SET DNS [${COLOR1}13${NC}] • RENEW CERT"
if [ "$Isadmin" = "ON" ]; then
echo -e "[${COLOR1}07${NC}] • MENU THEME   [${COLOR1}14${NC}] • INFORMATION"
ressee="menu-ip"
bottt="menu-bot"
else
ressee="menu"
